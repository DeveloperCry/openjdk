    ...
    implements Comparable<FloatBuffer>
{
    ...
    FloatBuffer(int mark, int pos, int lim, int cap,   // package-private
                 float[] hb, int offset, MemorySegmentProxy segment)
    {
    ...
    //
    FloatBuffer(int mark, int pos, int lim, int cap, MemorySegmentProxy segment) { // package-private
        this(mark, pos, lim, cap, null, 0, segment);
    }

    // Creates a new buffer with given base, address and capacity
    //
    FloatBuffer(float[] hb, long addr, int cap, MemorySegmentProxy segment) { // package-private
