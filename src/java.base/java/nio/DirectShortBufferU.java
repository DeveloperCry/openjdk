    ...
    implements DirectBuffer
{
    ...
    public short get() {
        try {
            return ((SCOPED_MEMORY_ACCESS.getShort(scope(), null, ix(nextGetIndex()))));
        } finally {
    ...
    public short get(int i) {
        try {
            return ((SCOPED_MEMORY_ACCESS.getShort(scope(), null, ix(checkIndex(i)))));
        } finally {
            Reference.reachabilityFence(this);
        }
    }
    ...
    public ShortBuffer put(short x) {
        ...
        try {
            SCOPED_MEMORY_ACCESS.putShort(scope(), null, ix(nextPutIndex()), ((x)));
        } finally {
            Reference.reachabilityFence(this);
        }
        return this;
    ...
    public ShortBuffer put(int i, short x) {
        ...
        try {
            SCOPED_MEMORY_ACCESS.putShort(scope(), null, ix(checkIndex(i)), ((x)));
        } finally {
            Reference.reachabilityFence(this);
        }
        return this;
