    ...
    implements DirectBuffer
{
    ...
    public char get() {
        try {
            return (Bits.swap(SCOPED_MEMORY_ACCESS.getChar(scope(), null, ix(nextGetIndex()))));
        } finally {
    ...
    public char get(int i) {
        try {
            return (Bits.swap(SCOPED_MEMORY_ACCESS.getChar(scope(), null, ix(checkIndex(i)))));
        } finally {
            Reference.reachabilityFence(this);
        }
    }
    ...
    public CharBuffer put(char x) {
        ...
        try {
            SCOPED_MEMORY_ACCESS.putChar(scope(), null, ix(nextPutIndex()), Bits.swap((x)));
        } finally {
            Reference.reachabilityFence(this);
        }
        return this;
    ...
    public CharBuffer put(int i, char x) {
        ...
        try {
            SCOPED_MEMORY_ACCESS.putChar(scope(), null, ix(checkIndex(i)), Bits.swap((x)));
        } finally {
            Reference.reachabilityFence(this);
        }
        return this;
