...
public class IBM1381 extends Charset
                        implements HistoricallyNamedCharset
{
    public IBM1381() {
        ...
        public String historicalName() { return "Cp1381"; }

    public boolean contains(Charset cs) {
        return ((cs.name().equals("US-ASCII")) || (cs instanceof IBM1381));
    }

    public CharsetDecoder newDecoder() {
        return new DoubleByte.Decoder(this, DecodeHolder.b2c, DecodeHolder.b2cSB, 0xa1, 0xfe, true);
    }
