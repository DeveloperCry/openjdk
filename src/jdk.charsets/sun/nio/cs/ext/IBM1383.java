...
public class IBM1383 extends Charset
                        implements HistoricallyNamedCharset
{
    public IBM1383() {
        ...
        public String historicalName() { return "Cp1383"; }

    public boolean contains(Charset cs) {
        return ((cs.name().equals("US-ASCII")) || (cs instanceof IBM1383));
    }
    ...
    static class EncodeHolder {
        static final char[] c2b = new char[0x6900];
