...
public class IBM970 extends Charset
                        implements HistoricallyNamedCharset
{
    public IBM970() {
        super("x-IBM970", ExtendedCharsets.aliasesFor("x-IBM970"));
    }

        public String historicalName() { return "Cp970"; }

    public boolean contains(Charset cs) {
        return ((cs.name().equals("US-ASCII")) || (cs instanceof IBM970));
    }
