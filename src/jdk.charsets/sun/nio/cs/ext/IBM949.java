...
public class IBM949 extends Charset
                        implements HistoricallyNamedCharset
{
    public IBM949() {
        super("x-IBM949", ExtendedCharsets.aliasesFor("x-IBM949"));
    }

        public String historicalName() { return "Cp949"; }
    ...
    public CharsetDecoder newDecoder() {
        return new DoubleByte.Decoder(this, DecodeHolder.b2c, DecodeHolder.b2cSB, 0xa1, 0xfe, false);
    }
    ...
    static class EncodeHolder {
        static final char[] c2b = new char[0x9800];
